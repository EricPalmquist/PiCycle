...
class BikeSpeed:
    ...
    def __del__(self):
        ...
        """ Cleanup bike speed calculator

        This code will run last when we no longer are using a BikeSpeed object
    ...
    def _pulse_detected(self, channel):
        ...
        self.curr_time_delta = current_time - self.prev_time
    ...
    def _calc_speed(self, pulse_delta, time_delta):
        ...
        if self.curr_time_delta > 0:
            rps = 1.0 / self.current_time_delta
            rpm = rps / 60.0
            mph = rpm * self.mph_factor
        else:
            mph = 0
    ...
    def curr_speed(self):
        ...
        pulse_delta = 1.0
        time_delta = (datetime.datetime.now() - self.prev_time).total_seconds()
